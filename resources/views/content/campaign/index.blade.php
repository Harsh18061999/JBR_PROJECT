        ...
        <div class="card mb-4">
            ...
            <div class="m-4">
                ...
                <div class="border p-4">
                    <p>Currently Avilable Link  :  <a class="mx-4" id="link_url" href="{{route('employee_register')}}">{{route('employee_register')}}</a> <i class=" btn btn-primary fa-solid fa-copy" id="copyLink"></i></p>
