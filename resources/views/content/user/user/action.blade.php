<div class="d-flex">
    ...
    @endif
    <a href="{{route('user.edit',$query->id)}}" title="Edit User" class="pointer"><i class="fa-solid fa-pen-to-square mx-2"></i></a>
    <a data-href="{{route('user.destory',$query->id)}}" title="Delete User" data-id="{{$query->id}}" class="delete pointer text-danger"><i class="mx-2 fa-solid fa-trash"></i></a>
</div>