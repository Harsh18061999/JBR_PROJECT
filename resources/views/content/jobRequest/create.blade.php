                    ...
                    <div class="row mx-4">
                        ...
                        <div class="col-lg-4">
                          <div class=" mb-4">
                            <div class="">
                              <div class="form-floating">
                                <input type="number" class="form-control" name="no_of_employee" id="no_of_employee" placeholder="Enter the no of employee to hire" aria-describedby="floatingInputHelp" />
