    ...
    <div class="row mt-0">
        <div class="text-center p-0">
            <div class="card px-0 pt-4 pb-0 d-flex justify-content-center">
                ...
                <hr class="mt-4 mx-4">
                <form id="client_from" action="{{ route('client.update', $client->id) }}" method="POST" enctype="multipart/form-data" novalidate> 
                  @csrf
                    <div class="row mx-4">
                            ...
                            <div class=" mb-4">
                              <div class="">
                                <div class="form-floating error_message">
                                  <input type="text" name="client_name" value={{$client->client_name}} class="form-control" id="client_name" placeholder="John" aria-describedby="floatingInputHelp" data-error="errNm1" />
                        ...
                        <div class="col-md-4">
                            <div class=" mb-4">
                                <div class="">
                                  <div class="form-floating error_message">
                                    <input type="text" name="supervisor" value="{{$client->supervisor}}" class="form-control" id="supervisor" placeholder="John" aria-describedby="floatingInputHelp" data-error="errNm1" />
                                ...
                                <div class="form-floating">
                                    <select id="job_category" name="job" class="form-select">
                                        ...
                                        @foreach($jobCategory as $key => $value)
                                          <option value="{{$value->id}}" {{$value->id == $client->job ? 'selected' : ''}} data-license="{{$value->license_status}}">{{$value->job_title}}</option>
                                        @endforeach
