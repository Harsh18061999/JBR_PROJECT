            ...
            <div class=" p-0">
                <div class="card px-0 pt-4 pb-0 d-flex justify-content-center">
                    ...
                    <form id="client_from" action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="w-100 row">
                                            ...
                                            <div class="col-md-6 my-2 form-floating error_message">
                                                <input type="text" name="supervisor[1]" class="form-control"
                                            ...
                                            <div class="col-md-6 my-2 form-group ">
                                                <div class="form-floating">
                                                    <textarea class="form-control" name="supervisor_address[1]" id="supervisor_address" rows="5"
                                                        cols="5"></textarea>
                                                    <label for="floatingInput">Supervisor Address</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="btn btn-sm btn-primary mx-2" id="more" data-id="1"><i
                        ...
                        <p class="mt-4 text-center">By clicking this button, you submit your information to the JBR Staffing
