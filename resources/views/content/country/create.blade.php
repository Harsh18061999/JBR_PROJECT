    ...
    <div class="row mt-0">
        <div class="text-center p-0">
            <div class="card px-0 pt-4 pb-0 d-flex justify-content-center">
                ...
                <hr class="mt-4 mx-4">
                <form id="country_from" action="{{route('country.store')}}" method="POST" enctype="multipart/form-data" novalidate> 
                  @csrf
                    <div class="row mx-4">
                            ...
                            <div class=" mb-4">
                              <div class="">
                                <div class="form-floating">
                                  <input type="text" class="form-control" name="country_code" id="country_code" placeholder="Country Code" aria-describedby="floatingInputHelp" />
                            ...
                            <div class=" mb-4">
                              <div class="">
                                <div class="form-floating error_message">
                                  <input type="text" name="name" class="form-control" id="name" placeholder="Country Name" aria-describedby="floatingInputHelp" data-error="errNm1" />
