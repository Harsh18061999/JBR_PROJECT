<div class="d-flex">
    ...
    @if($query->status != 2)
        <a data-href="{{route('employee.block',$query->id)}}" class="text-danger block_employee" title="Block"><i class="mx-2 fa-solid fa-lock"></i></a>
    @else
        <a data-href="{{route('employee.unblock',$query->id)}}" class="unblock_employee"><i class="mx-2 fa-solid fa-lock-open" title="UnBlock"></i></a>
    @endif
</div>