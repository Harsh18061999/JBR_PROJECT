<div class="d-flex">
    ...
    @endif
    <a href="{{route('province.edit',$query->id)}}" title="Edit Province" class="pointer"><i class="fa-solid fa-pen-to-square mx-2"></i></a>
    <a data-href="{{route('province_destroy.destory',$query->id)}}" title="Delete Province" data-id="{{$query->id}}" class="delete pointer text-danger"><i class="mx-2 fa-solid fa-trash"></i></a>
</div>