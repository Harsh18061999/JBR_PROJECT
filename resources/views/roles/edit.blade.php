...
@section('content')
    <div class="bg-light p-4 rounded">
        <div class="text-center p-0">
            <h3><strong><i class="fa-solid fa-user mx-2"></i>Edit Role</strong></h3>
        </div>
                                ...
                                <div class="card-header">
                                    <div class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" id="{{ $key }}" value="{{ $key }}"
                                            ...
                                            {{ count($permission) == isset($parent_array[$key]) ? 'checked' : '' }}>
                                    ...
                                    <ul class="todo-list" data-widget="todo-list">
                                        ...
                                        @foreach ($permission as $k => $value)
                                            ...
                                            <li class="pl-4">
                                                ...
                                                <div class="icheck-primary d-inline ml-2">
                                                    <input
                                                        {{ in_array($value->name, $rolePermissions_array) ? 'checked' : '' }}
                                                        type="checkbox" class="{{ $key }} permission child"
