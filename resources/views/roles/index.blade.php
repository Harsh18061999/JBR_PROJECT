            ...
            <div class="d-flex">
                <div class="mx-2">
                    <a href="{{route('roles.create')}}" >
                        <button type="button" class="btn btn-primary" title="Add Role">
          ...
          <div class="d-grid p-3">
            <div class="row">
                ...
                <div class="col-lg-3 mt-2">
                    <br>
                      <button type="button" id="role_search" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i> </button>
                      <button type="button" id="role_search_reset" class="btn btn-primary"><i class="fa-solid fa-arrows-rotate"></i> </button>
                </div>
            </div>
          </div>
        </div>
