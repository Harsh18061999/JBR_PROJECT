...
class JobListTable extends DataTable
{
    /**
    ...
    {   
        return (new EloquentDataTable($query))->rawColumns(['action','employee_list','status','time_sheet'])
    ...
    {  
        if(auth()->user()->hasRole('admin')){
            return [
                ...
                Column::make('time_sheet')->sortable(false) ,
